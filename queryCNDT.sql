...
Values ('HD008','KH004','SP003','CNDT','NV002',N'Xịt Khoáng',1,200000,200000)
...
-- ktra thử thêm một hóa đơn
select*from HoaDon
select *from NhaKho
select *from SanPham

insert into HoaDon(MaHD,MaKH,MaSP,MaCN,MaNV,TenSP,SoLuong,GiaBan,TongTien)
Values ('HD007','KH0011','SP003','CNDT','NV002',N'Xịt Khoáng',1,200000,200000)

delete from HoaDon where MaHD= 'HD007'